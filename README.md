...
<table align="center" border="0">
  ...
  <tr>
    ...
    <td align="left">
       ...
       <a href="https://deepwiki.com/bsv-blockchain/go-safe-conversion"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki"></a>
    </td>
  </tr>
</table>
...
All unit tests and [examples](examples) run via [GitHub Actions](https://github.com/bsv-blockchain/go-safe-conversion/actions) and use [Go version 1.25.x](https://go.dev/doc/go1.25). View the [configuration file](.github/workflows/fortress.yml).
